CLASS LHC_ZDR_R_INV_STOCK DEFINITION INHERITING FROM CL_ABAP_BEHAVIOR_HANDLER.
  PRIVATE SECTION.
    METHODS:
      GET_GLOBAL_AUTHORIZATIONS FOR GLOBAL AUTHORIZATION
        IMPORTING
           REQUEST requested_authorizations FOR StockInventory
        RESULT result.
*        METHODS:
*
*      createPurchaseRequisition FOR MODIFY
*        IMPORTING keys FOR ACTION StockInventory~createPurchaseRequisition RESULT result.
*
*    METHODS calculateStockStatus FOR DETERMINE ON SAVE
*      IMPORTING keys FOR StockInventory~calculateStockStatus.
*
*    METHODS:
*      validateStock FOR VALIDATE ON SAVE
*        IMPORTING keys FOR StockInventory~validateStock.
ENDCLASS.

CLASS LHC_ZDR_R_INV_STOCK IMPLEMENTATION.
*  """"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
*                                          WHEN <ls_stock>-ReorderPoint < 0  THEN <ls_stock>-ReorderPoint
